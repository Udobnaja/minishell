...
int								sh_get_tmpdir(const t_env_store *env,
									char *tmpdir, size_t max_name_size);
int								sh_mktmpfd(const t_env_store *env, char *path,
									const char *prefix);
...
void							sh_set_signal_handler(int sig,
									void (*handler)(int));
