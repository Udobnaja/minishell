...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 21:59:26 by audobnai          #+#    #+#             */
/*   Updated: 2025/10/28 17:37:44 by audobnai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "heredoc_internal.h"

static t_heredoc_status	heredoc_write_line_expanded(int fd,
							const char *document, t_shell *sh);
static t_heredoc_status	heredoc_write_line_raw(int fd, const char *document);
static t_heredoc_status	heredoc_write_expansion(const char *str, int fd,
							t_shell *sh, size_t *consumed);
static t_heredoc_status	heredoc_write_until_expansion(const char *str, int fd,
							size_t *consumed);
