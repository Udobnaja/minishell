...
/*   Updated: 2025/10/28 17:38:53 by audobnai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_heredoc_status	heredoc_to_fd(char *eof, int fd, int has_expansion,
							t_shell *sh);

t_heredoc_result	heredoc_write_to_tmpfile(t_shell *sh, char *eof,
		int has_expansion)
{
