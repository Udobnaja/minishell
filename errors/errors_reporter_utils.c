...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   errors_reporter_utils.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: audobnai <audobnai@student.hive.fi>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 22:38:32 by audobnai          #+#    #+#             */
/*   Updated: 2025/10/27 22:38:33 by audobnai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (error->payload.token != NULL || error->payload.identifier != NULL
		|| error->payload.path != NULL || error->payload.command != NULL
