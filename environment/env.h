...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 22:34:07 by audobnai          #+#    #+#             */
/*   Updated: 2025/10/27 22:34:08 by audobnai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_env_status				env_set(t_env_store *store, const char *key,
								const char *value);
void						env_unset(t_env_store *store, const char *key);
const char					*env_get_value(const t_env_store *store,
								const char *key);

char						**env_to_envp(const t_env_store *store);
t_env_pair					*env_pairs_dup(const t_env_store *store);
void						env_pairs_free(t_env_pair *pairs,
								const size_t size);
