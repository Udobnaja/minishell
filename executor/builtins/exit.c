...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 22:48:43 by alavrukh          #+#    #+#             */
/*   Updated: 2025/10/27 22:48:44 by alavrukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_exec_result	exec_exit_result(t_exec_flow flow, t_exec_status status,
							int exit_code);
...
/* 
 Function generates a result structure (t_exec_result) for the case
when an error occurs, but the shell needs to continue executing,
